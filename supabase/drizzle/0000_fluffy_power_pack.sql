...
ALTER TABLE "transactionHistory" ADD CONSTRAINT "transactionHistory_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user" ADD CONSTRAINT "user_roleTypeId_userRoleTypes_id_fk" FOREIGN KEY ("roleTypeId") REFERENCES "public"."userRoleTypes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "first_name" ON "user" USING btree ("first_name");--> statement-breakpoint
CREATE INDEX "last_name" ON "user" USING btree ("last_name");